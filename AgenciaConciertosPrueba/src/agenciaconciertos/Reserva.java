...
public class Reserva {
    ...
    private ArrayList<Entrada> entradaArray; 

    public ArrayList<Entrada> getEntradaArray() {
        return entradaArray;
    }

    public void setEntradaArray(ArrayList<Entrada> entradaArray) {
        this.entradaArray = entradaArray;
    }
    ...
    public Reserva(int numEntradas, Date fechaMaxima, String codigoDescuento, ArrayList<Entrada> entradaArray) {
        this.numEntradas = numEntradas;
        this.fechaMaxima = fechaMaxima;
        this.codigoDescuento = codigoDescuento;
        this.entradaArray = entradaArray;
    ...
    public Reserva(Reserva r) {
        ...
        this.entradaArray = r.getEntradaArray();
    }
    public Reserva() {
    }
