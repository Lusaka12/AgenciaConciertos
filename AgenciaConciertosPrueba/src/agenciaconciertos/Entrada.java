...
public class Entrada {
    ...
    private long idCompra; //atributo que sirve para guardar el id de la clase compra en la clase entrada. 
    private boolean disponible = false; //atributo que nos permite saber si una entrada esta disponible para su compra o si esta reservada.
    ...
    public Entrada(long id, double precio, boolean esVIP, Concierto concierto, long idCompra, boolean disponible) {
        this.id = id;
        this.precio = precio;
        this.esVIP = esVIP;
        this.concierto = concierto;
    ...
    public String data() {
        ...
        return this.getId()+"|"+this.getPrecio()+"|"+this.getEsVIP()+"|"+this.isDisponible()+"|"+this.getIdCompra() +"|"+ this.getConcierto();
    }
